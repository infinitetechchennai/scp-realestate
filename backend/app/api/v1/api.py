...
from app.api.v1.endpoints import plots, projects, bookings, payments, notifications, audit_logs
...
api_router.include_router(audit_logs.router, prefix="/audit-logs", tags=["Audit Trail & Logs"])
