...
export const mockProjects: Project[] = [
  {
    ...
    confirmedPlots: 40,
    soldPlots: 16,
    totalValue: 486000000,
    status: 'active',
    blueprintUrl: '/blueprint.png',
    createdAt: d(-60),
  },
];
...
export const mockChannelPartners: ChannelPartner[] = [
  { id: 'cp-001', name: 'Prasad Venkat', email: 'channel@example.com', phone: '9988776655', companyName: 'Prasad Realtors', address: '22, Banjara Hills, Hyderabad', aadhar: '1111 2222 3333', pan: 'PQRST1111U', bankDetails: 'HDFC Bank, A/C: 12345678', registrationFee: 500, registrationPaid: true, status: 'approved', totalCustomers: 5, totalLeads: 18, totalBookings: 9, totalSold: 4, totalRevenue: 27610000, commission: 276100, pendingCommission: 50000, createdAt: d(-150) },
  { id: 'cp-002', name: 'Sunrise Properties', email: 'sunrise@example.com', phone: '9988776644', companyName: 'Sunrise Properties', address: '44, Jubilee Hills, Hyderabad', aadhar: '4444 5555 6666', pan: 'UVWXY4444Z', bankDetails: 'SBI, A/C: 87654321', registrationFee: 500, registrationPaid: true, status: 'approved', totalCustomers: 4, totalLeads: 12, totalBookings: 6, totalSold: 2, totalRevenue: 9450000, commission: 94500, pendingCommission: 25000, createdAt: d(-100) },
  { id: 'cp-003', name: 'Prime Estates', email: 'prime@example.com', phone: '9988776633', companyName: 'Prime Estates', address: '66, Kondapur, Hyderabad', aadhar: '7777 8888 9999', pan: 'ABCDE7777F', bankDetails: 'Axis Bank, A/C: 11223344', registrationFee: 500, registrationPaid: true, status: 'approved', totalCustomers: 3, totalLeads: 9, totalBookings: 4, totalSold: 3, totalRevenue: 15535000, commission: 155350, pendingCommission: 0, createdAt: d(-80) },
  { id: 'cp-004', name: 'Radha Properties', email: 'radha@example.com', phone: '9988776622', companyName: 'Radha Properties', address: '88, Madhapur, Hyderabad', aadhar: '2222 3333 4444', pan: 'GHIJK2222L', bankDetails: 'ICICI, A/C: 99887766', registrationFee: 500, registrationPaid: true, status: 'pending', totalCustomers: 0, totalLeads: 0, totalBookings: 0, totalSold: 0, totalRevenue: 0, commission: 0, pendingCommission: 0, createdAt: d(-2) },
  { id: 'cp-005', name: 'Lakshmi Ventures', email: 'lakshmi.ventures@example.com', phone: '9988776611', companyName: 'Lakshmi Ventures', address: '110, Ameerpet, Hyderabad', aadhar: '5555 6666 7777', pan: 'MNOPQ5555R', bankDetails: 'BOI, A/C: 55443322', registrationFee: 500, registrationPaid: false, status: 'pending', totalCustomers: 0, totalLeads: 0, totalBookings: 0, totalSold: 0, totalRevenue: 0, commission: 0, pendingCommission: 0, createdAt: d(-1) },
];
