...
import { Plus, Eye, Map, Upload, Image as ImageIcon, FileSpreadsheet, CheckCircle, Sparkles } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                ...
                {uploadedImagePreview ? (
                  ...
                  <p className="text-xs text-blue-700 font-bold mt-3 underline">Click to choose image file →</p>
                )}
              </div>
